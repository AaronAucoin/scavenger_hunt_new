...
class compLabHall extends StatefulWidget {
  const compLabHall({super.key});

  @override
  State<compLabHall> createState() => _compLabHallState();
}

class _compLabHallState extends State<compLabHall> {
  int _selectedIndex = 0;
  final GlobalState _globalState = GlobalState();

  void _onItemTapped(int index) {
    if (index == 1) {
      _globalState.lastGameScreen = 'compLabHall';
